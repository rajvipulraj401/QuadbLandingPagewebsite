      ...
      <div className="relative z-10 text-white h-full">
        <div className="text-center pt-36 sm:gap-4 flex flex-col items-center justify-center">
          ...
          {/* <h1 className="relative text-[30px] ss:text-[36px] xxs:text-[42px] sm:text-[56px] md1:text-[64px] md:text-[72px] lg:text-[78px] xl:text-[84px] font-proxima mt-4 font-bold leading-[117.6px]">
            Embrace the Quest
            <span className="font-proxima absolute inset-0 w-full h-full overflow-hidden bg-clip-text text-transparent transition-all duration-500 bg-gradient-to-r from-yellow-400 via-yellow-300 to-cyan-400 hover:opacity-100 opacity-0">
              Embrace the Quest
            </span>
          </h1> */}

          <h1 className=" gradient-text relative text-[30px] ss:text-[36px] xxs:text-[42px] sm:text-[56px] md1:text-[64px] md:text-[72px] lg:text-[78px] xl:text-[84px] font-proxima mt-4 font-bold leading-[117.6px]">
            Embrace the Quest
          </h1>
